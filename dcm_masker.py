...
def create_mask(input_img, model):
	...
	#Resize the mask with your helper function resize_img() in utils. remove singleton dim before hand!
	#return resized mask
	pass
...
if __name__ == '__main__':
	...
	4) save this mask somewhere, and make sure it can be tied to which dicom it came from.
	'''
	weights_path = ''
